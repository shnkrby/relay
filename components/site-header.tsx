...
export function SiteHeader({ orgName = "Workspace", role = "Member" }: SiteHeaderProps) {
      ...
      <div className="flex items-center gap-1 lg:gap-2">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium text-slate-600 dark:text-slate-300">
            {orgName} / <span className="text-slate-900 dark:text-white font-semibold">{pageName}</span>
          </span>
