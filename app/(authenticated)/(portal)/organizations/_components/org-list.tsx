      ...
      {organizations.map((orgMember, index) => {
        ...
        return (
          <Link key={org.id || index} href={`/${org.slug}`} className="block h-full outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-xl transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl">
            <Card className="h-full flex flex-col bg-white/70 dark:bg-slate-900/50 backdrop-blur-md border border-white/20 dark:border-slate-800/50 shadow-sm overflow-hidden group">
              <CardHeader className="flex flex-row items-start justify-between pb-2 relative z-10">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1 mt-1">
                    ...
                    <div className="text-sm text-slate-500 dark:text-slate-400 flex items-center pt-1 font-medium">
                ...
                <Badge 
                  ...
                  className={`
                    ...
                    ${orgMember.role === 'member' ? 'bg-slate-500/10 text-slate-700 dark:bg-slate-500/20 dark:text-slate-300 border-slate-500/20' : ''}
              ...
              <CardFooter className="pt-4 pb-4 px-6 mt-auto border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/30 dark:bg-slate-900/20 flex items-center justify-between relative z-10">
