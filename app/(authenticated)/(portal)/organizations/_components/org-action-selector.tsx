...
export function OrgActionSelector() {
  return (
    <>
      <JoinOrgDialog>
        <button className="flex flex-col items-center justify-center h-full min-h-[240px] w-full rounded-xl border-2 border-dashed border-slate-200 dark:border-slate-800 bg-transparent hover:bg-slate-50/50 dark:hover:bg-slate-900/50 hover:border-blue-500/50 dark:hover:border-blue-400/50 transition-all duration-300 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">
          ...
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">Join Organization</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2 text-center max-w-[200px]">Have a code? Join your team's workspace.</p>
        </button>
      </JoinOrgDialog>
      ...
      <CreateOrgDialog>
        <button className="flex flex-col items-center justify-center h-full min-h-[240px] w-full rounded-xl border-2 border-dashed border-slate-200 dark:border-slate-800 bg-transparent hover:bg-slate-50/50 dark:hover:bg-slate-900/50 hover:border-purple-500/50 dark:hover:border-purple-400/50 transition-all duration-300 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500">
          ...
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">Start New Organization</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2 text-center max-w-[200px]">Create a fresh workspace for your team.</p>
        </button>
      </CreateOrgDialog>
    </>
  )
